...
{
    public class GetProblemsByTouristHandler : IRequestHandler<GetProblemsByTouristQuery, List<ProblemDto>>
    {
        private readonly IProblemRepository _problemRepository;
        private readonly ITourRepository _tourRepository;
        private readonly ITouristRepository _touristRepository;

        public GetProblemsByTouristHandler(
        ...
        public async Task<List<ProblemDto>> Handle(GetProblemsByTouristQuery request, CancellationToken cancellationToken)
        {
            var problems = await _problemRepository.GetByTouristAsync(request.TouristId);
